...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA5     ------> TIM2_CH1
    */
    HAL_GPIO_DeInit(GPIOA, Left_Motor_Encoder_B_Pin|Left_Motor_Encoder_A_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB5     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(Right_Motor_Encoder_B_GPIO_Port, Right_Motor_Encoder_B_Pin);

    HAL_GPIO_DeInit(Right_Motor_Encoder_A_GPIO_Port, Right_Motor_Encoder_A_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PD2     ------> UART5_RX
    */
    HAL_GPIO_DeInit(Raspberrypi_TX_GPIO_Port, Raspberrypi_TX_Pin);

    HAL_GPIO_DeInit(Raspberrypi_RX_GPIO_Port, Raspberrypi_RX_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, Arduino_TX_Pin|Arduino_RX_Pin);
