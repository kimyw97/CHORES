...
#define IR_Sensor_1_Pin GPIO_PIN_4
#define IR_Sensor_2_Pin GPIO_PIN_5
...
void set_motor_pwm(float left, float right) {
    ...
    HAL_GPIO_WritePin(Left_GPIO_Port, Left_In1_Pin, left_dir ? GPIO_PIN_SET : GPIO_PIN_RESET);
    HAL_GPIO_WritePin(Left_GPIO_Port, Left_In2_Pin, left_dir ? GPIO_PIN_RESET : GPIO_PIN_SET);
    HAL_GPIO_WritePin(Right_GPIO_Port, Right_In1_Pin, right_dir ? GPIO_PIN_SET : GPIO_PIN_RESET);
    HAL_GPIO_WritePin(Right_GPIO_Port, Right_In2_Pin, right_dir ? GPIO_PIN_RESET : GPIO_PIN_SET);
...
void send_infrared_feedback() {
    uint8_t s1 = HAL_GPIO_ReadPin(GPIOD, IR_Sensor_1_Pin);
    uint8_t s2 = HAL_GPIO_ReadPin(GPIOD, IR_Sensor_2_Pin);
    char msg[32];
