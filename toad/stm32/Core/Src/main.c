...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, Left_Motor_In1_Pin|Left_Motor_In2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, Right_Motor_In1_Pin|Right_Motor_In2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : Right_Motor_In1_Pin Right_Motor_In2_Pin */
